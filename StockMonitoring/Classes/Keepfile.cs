...
namespace StockMonitoring.Classes
{
    public static class Keepfile
    {
        ...
        public async static void ReadSerialSetting(int port, SerialPort serialPort)
        {
            ...
            {
                string com = await File.ReadAllTextAsync(PortSetting);
