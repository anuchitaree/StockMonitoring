...
using StockMonitoring.MiniUserControl;
...
namespace StockMonitoring
{
    public partial class Form1 : Form
    {
        ...
        private async void AsyncInsertTable1(string readtxt)
        {
            try
            {
        ...
        private async void AsyncInsertTable2(string readtxt)
        {
            try
            {
                CultureInfo ci = new CultureInfo("en-US");
        ...
        private async void AsyncInsertTable3(string readtxt)
        {
            try
            {
                CultureInfo ci = new CultureInfo("en-US");
        ...
        private async void AsyncInsertTable4(string readtxt)
        {
            try
            {
                CultureInfo ci = new CultureInfo("en-US");
        ...
        #region MEMU
        private void patternPartNumberToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.PnlSub.Controls.Clear();
            var ctrl25 = new PatternUserControl();
            this.PnlSub.Controls.Add(ctrl25);
        }
        ...
        private void menuStrip1_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            //switch (menu)
            //{
            //    case "channel1ToolStripMenuItem":
            //        var ctrl21 = new PatternUserControl();
            //        this.PnlSub.Controls.Add(ctrl21);
            //        break;
            //    case "channel2ToolStripMenuItem":
            //        var ctrl22 = new PatternUserControl();
            //        this.PnlSub.Controls.Add(ctrl22);
            //        break;
            //    case "channel3ToolStripMenuItem":
            //        var ctrl23 = new PatternUserControl();
            //        this.PnlSub.Controls.Add(ctrl23);
            //        break;
            //    case "channel4ToolStripMenuItem":
            //        var ctrl24 = new PatternUserControl();
            //        this.PnlSub.Controls.Add(ctrl24);
            //        break;

            //    case "patternPartNumberToolStripMenuItem":
            //        var ctrl25 = new PatternUserControl();
            //        this.PnlSub.Controls.Add(ctrl25);
            //        break;
            //}
        ...
        {
            this.PnlSub.Controls.Clear();
            var ctrl25 = new PortSettingUserControl("1");
            this.PnlSub.Controls.Add(ctrl25);
        }
        ...
        {
            this.PnlSub.Controls.Clear();
            var ctrl25 = new PortSettingUserControl("2");
            this.PnlSub.Controls.Add(ctrl25);
        }
        ...
        {
            this.PnlSub.Controls.Clear();
            var ctrl25 = new PortSettingUserControl("3");
            this.PnlSub.Controls.Add(ctrl25);
        }
        ...
        {
            this.PnlSub.Controls.Clear();
            var ctrl25 = new PortSettingUserControl("4");
            this.PnlSub.Controls.Add(ctrl25);
        }
        ...
        {
            this.PnlSub.Controls.Clear();
            var ctrl25 = new LoginUserControl();
            this.PnlSub.Controls.Add(ctrl25);
        }
        ...
        {
            this.PnlSub.Controls.Clear();
            var ctrl25 = new AccountUserControl();
            this.PnlSub.Controls.Add(ctrl25);
        }
        #endregion
        ...
        private void updateStockListToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Visible = false;
            var frm = new CRUDForm();
            frm.CRUDClosed += new EventHandler(CRUDClosed_Closed);
            frm.TopMost = true;
            frm.Show();
        }
        ...
        private void stockBalanceHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Visible = false;
            var frm = new StockBalanceHistory();
            frm.StockBalanceHistoryClosed += new EventHandler(StockBalanceHistoryClosed_Closed);
            frm.TopMost = true;
            frm.Show();
        }
